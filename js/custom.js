...
$(document).on('ready', function() {
    ...
    $("#resume-btn").on('click', function() {
        if (!firstTime) {
            ...
            var line4 = new ProgressBar.Line('#bar4', {
                strokeWidth: 20,
                easing: 'easeInOut',
                duration: 1400,
                color: '#f4d03f',
            ...
            var line5 = new ProgressBar.Line('#bar5', {
                strokeWidth: 20,
                easing: 'easeInOut',
                duration: 1400,
                color: '#f4d03f',
            ...
            var line6 = new ProgressBar.Line('#bar6', {
                strokeWidth: 20,
                easing: 'easeInOut',
                duration: 1400,
                color: '#f4d03f',
            ...
            var line7 = new ProgressBar.Line('#bar7', {
                strokeWidth: 20,
                easing: 'easeInOut',
                duration: 1400,
                color: '#f4d03f',
